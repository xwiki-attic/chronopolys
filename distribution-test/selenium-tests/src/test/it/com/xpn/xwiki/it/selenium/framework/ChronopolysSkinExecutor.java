...
/**
 * Implementation of skin-related actions for the Chronopolys skin.
 * 
 * @version $Id: $
 */
public class ChronopolysSkinExecutor implements SkinExecutor
{
    ...
    public ChronopolysSkinExecutor(AbstractXWikiTestCase test)
    {
        this.test = test;
    }
    ...
    public void loginAsChronoAdmin()
    {
        login("Administrator", "admin", false);
    }

    public void loginAsChronoManager()
    {
        login("Manager", "admin", false);
    }

    public void loginAsChronoUser()
    {
